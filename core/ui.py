...
def render_benchmark_report(results: list, target: str):
    from core.ui_batch import render_benchmark_report as _render_benchmark_report

    return _render_benchmark_report(results, target)


def render_batch_validate_report(results: list, target: str, policy_config=None):
    from core.ui_batch import render_batch_validate_report as _render_batch_validate_report

    return _render_batch_validate_report(results, target, policy_config=policy_config)
